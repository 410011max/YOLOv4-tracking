...
def run(
    ...
    for frame_idx, batch in enumerate(dataset):
        ...
        p = [preds]
        #  [ 95.20782,  76.78030, 121.20023,  91.10449,   0.68187,   2.00000],
        ...
        for i, det in enumerate(p):  # detections per image
            ...
            if det is not None and len(det):
                # print(np.array(det[0].to('cpu'), dtype='int'))
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='video/cars1.mp4', help='file/dir/URL/glob, 0 for webcam')  
